...
class CalendarWeekDay{
   ...
   */
   ...
   function selectPart($ymd){
     ...
     if($one_part_frame == "0"){
       $html[] = '<option class="main-part" value="1" disabled>リモ1部(残り0枠)</option>';
     }else{
       $html[] = '<option class="main-part" value="1">リモ1部(残り'.$one_part_frame.'枠)</option>';
     }
     if($two_part_frame == "0"){
       $html[] = '<option class="main-part" value="2" disabled>リモ2部(残り0枠)</option>';
     }else{
       $html[] = '<option class="main-part" value="2">リモ2部(残り'.$two_part_frame.'枠)</option>';
     }
     if($three_part_frame == "0"){
       $html[] = '<option class="main-part" value="3" disabled>リモ3部(残り0枠)</option>';
     }else{
       $html[] = '<option class="main-part" value="3">リモ3部(残り'.$three_part_frame.'枠)</option>';
     }
     $html[] = '</select>';
     return implode('', $html);
   }
